...
if &t_Co >= 256 || has('gui_running')
  hi Normal           ctermbg=235  ctermfg=250  guibg=#2B303A guifg=#bcbcbc cterm=NONE           gui=NONE

  set background=dark

  hi Comment          ctermbg=NONE ctermfg=240  guibg=NONE    guifg=#696966 cterm=NONE           gui=NONE
  ...
  hi LineNr           ctermbg=234  ctermfg=242  guibg=#252931 guifg=#6c6c6c cterm=NONE           gui=NONE
  ...
  hi CursorLine       ctermbg=236  ctermfg=NONE guibg=#39404C guifg=NONE    cterm=NONE           gui=NONE
  hi CursorLineNr     ctermbg=236  ctermfg=73   guibg=#2B303A guifg=#5fafaf cterm=NONE           gui=NONE
