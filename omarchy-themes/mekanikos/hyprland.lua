...
local transparent = "rgba(55555588)"

-- Mekanikos owns its rounded client shape and focus ring. Hyprland's native
-- border tracks focus; borders-plus-plus is static and would paint every window.
hl.config({
	general = {
		border_size = 4,
		gaps_in = 2,
